...
ynh_add_php7.2-fpm_config () {
	finalphpconf="/etc/php/7.2/fpm/pool.d/$app.conf"
	...
	then
		finalphpini="/etc/php/7.2/fpm/conf.d/20-$app.ini"
...
ynh_remove_php7.2-fpm_config () {
	ynh_secure_remove "/etc/php/7.2/fpm/pool.d/$app.conf"
	ynh_secure_remove "/etc/php/7.2/fpm/conf.d/20-$app.ini" 2>&1
	sudo systemctl reload php7.2-fpm
}
